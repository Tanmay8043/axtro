<script>
  ...
  import { quintOut } from "svelte/easing";
    ...
    var lat = toDegreesMinutesAndSeconds($dataValue.place.longitude);
    var latitude = lat.degrees + ":" + lat.minutes + ":" + lat.seconds;
    
    var long = toDegreesMinutesAndSeconds($dataValue.place.latitude);
